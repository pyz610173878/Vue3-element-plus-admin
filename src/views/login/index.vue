            ...
            <div class="login_">
                <el-form ref="account_form" :model="data.form" :rules="data.form_rules" autocomplete="on">
                    <div class="title-container">
                        <h3 class="title-size">Vue3 element-plus 后台管理系统</h3>
                    </div>
                    <ul class="login-tab">
                    ...
                    <el-form-item prop="username" class="el-form-item">
                        <el-input v-model="data.form.username" placeholder="Username" clearable size="large"
                    ...
                    <el-form-item>
                        <el-button type="danger" @click="login" :disabled="false" class="el-button-block">
...
//     // 获取“确认密码”
//     const passwordsValue = data.form.password;
//     if (value === '') {
//         data.code_button_disabled = true
...
//     let regPassword = validate_password(value);
//     // 获取“密码”
//     const passwordValue = data.form.passwords;
//     const passwordsValue = data.form.password;
//     if (value === '') {
//         data.code_button_disabled = true
//     } else if (!regPassword) {
...
//         data.code_button_disabled = false
//     } else if (passwordValue !== passwordsValue) {
...
const login = () => {
    ...
    Login(requestDatas).then(response => {
        ElMessage({
